...
<?php
    $row_list = array();
    $result = mysqli_query($con,"select ebook.*, author.fname as author_fname, author.lname as author_lname from ebook inner join admin on admin.admin_id = ebook.admin_id inner join author on ebook.author_id = author.author_id limit $start, $end");
                        ...
                        <?php 
                            ...
                            foreach($row_list as $row){
                                echo '<tr>';
                                    ...
                                    echo '<td><img src="resources/uploads/admins/admin'.$row['admin_id'].'/'.$row['cover_pic'].'" style="border-radius:50%" weidth="50px" height="50px" /></td>';
