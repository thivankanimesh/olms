...
<?php
    $row_list = array();
    $result = mysqli_query($con,"select*from publisher where seller_id = $seller_id limit $start, $end");
...
if(isset($_POST["form-add-publisher"])){
    ...
    $query = "insert into publisher (fname,lname,email,seller_id) values ('$fname','$lname','$email',$seller_id)";
