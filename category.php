        ...
        <div class="row" style="margin-top: 15px">
            <div class="col-sm">
                <div style="margin-bottom: 5px">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#category-add-modal">Add New</button>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            foreach($row_list as $row){
                                echo '<tr>';
                                    ...
                                    echo '<div class="float-right">';
                                        echo '<td>';
                                            echo '<button class="btn btn-warning" style="margin-right:10px" type="button" data-toggle="modal" data-target="#category-view-modal'.$row['category_id'].'">View</button>';
                                            echo '<button class="btn btn-success" style="margin-right:10px" type="button" data-toggle="modal" data-target="#category-update-modal'.$row['category_id'].'">Update</button>';
                                            echo '<button class="btn btn-danger" style="margin-right:10px" type="button" data-toggle="modal" data-target="#category-delete-modal'.$row['category_id'].'">Delete</button>';
                                        echo '</td>';
                                    echo '</div>';
