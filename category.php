...
<?php
    ...
    $result = mysqli_query($con,"select count(category_id) from category inner join seller on seller.seller_id = category.seller_id where category.seller_id=$seller_id");
