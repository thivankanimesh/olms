                ...
                <form action="publisher.php?page=<?php echo $page?>" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="lname" type="text" value="<?php echo $row['lname']?>" placeholder="Enter First Name" minlength="3" maxlength="10" pattern="^[a-zA-Z]+$" title="Last name must be 3 or more letters & need to be letters only" required/>
                        </div>
                    </div>
                    <div class="form-row">
