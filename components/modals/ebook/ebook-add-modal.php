    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <form action="ebook.php?page=<?php echo $page?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="coverpic" type="file" accept="image/x-png,image/gif,image/jpeg" required />
                        </div>
                        <div class="form-group col-md-6">
            ...
            <div class="modal-footer">
                    ...
                    <input class="btn btn-primary" style="font-size: 13px;" name="form-add-ebook" type="submit" value="Add" />
                </form>
            </div>
        </div>
    </div>
